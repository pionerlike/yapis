...
program : (NEWLINE | statement)* functionDefine* EOF;
...
statement : (forCycle | ifBlock) |
((print | functionCall |  elementDeclaration | listDeclaration | add | clear | remove | concate) (';' | NEWLINE));

compare : (equalNames | contains | checkIsEmpty | compareGE | compareGT | compareLE | compareLT | compareEQ) (';' | NEWLINE);
...
checkIsEmpty : IS_EMPTY OPEN_BRACKET NAME CLOSE_BRACKET;
